...
class CardEvaluationApp(tk.Tk):
    def __init__(self):
        ...
        self.hypothesis_label.grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.dropdown = tk.OptionMenu(self, self.selected_option, *options, command=self.on_select)
        self.dropdown.grid(row=1, column=0, padx=10, pady=5, sticky="ew") 
        ...
        self.hypothesis_label.grid(row=2, column=0, padx=10, pady=5, sticky="w")
        ...
        self.source_entry.grid(row=3, column=0, padx=10, pady=5)

        self.hypothesis_label = tk.Label(self, text="Hypothesis",font=self.label_font,foreground="#86A789",background="#EBF3E8")
        self.hypothesis_label.grid(row=4, column=0, padx=10, pady=5, sticky="w")
        ...
        self.hypothesis_entry.grid(row=5, column=0, padx=10, pady=5)

        self.hypothesis_label = tk.Label(self, text="Target",font=self.label_font,foreground="#86A789",background="#EBF3E8")
        self.hypothesis_label.grid(row=6, column=0, padx=10, pady=5, sticky="w")
        ...
        self.target_entry.grid(row=7, column=0, padx=10, pady=5)
        ...
        self.button.grid(row=8, column=0, columnspan=2, padx=10, pady=5, sticky="ew")
    ...
    def create_progess_bar(self):
        ...
        self.hallucination_label.grid(row=9, column=0, padx=10, pady=5, sticky="w")

        self.not_hallucination = tk.Label(self, text="Not-Hallucination",font=self.label_font,foreground="#86A789",background="#EBF3E8")
        self.not_hallucination.grid(row=9, column=0, padx=10, pady=5, sticky="e")
        style = ttk.Style() 
        ...
        self.hallu_bar.grid(row=10, column=0, columnspan=2, padx=10, pady=5, sticky="ew")
        ...
        self.semantic_label.grid(row=11, column=0, padx=10, pady=5, sticky="w")
    ...
    def on_button_click(self):
        ...
        self.progress_bar.grid(row=9, column=0, columnspan=2, padx=10, pady=5, sticky="ew")
